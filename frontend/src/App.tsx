        ...
        <div className="flex justify-between items-center px-6 h-16 w-full max-w-screen-2xl mx-auto">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex gap-6">
              <a className="text-[#6bff8f] border-b-2 border-[#6bff8f] pb-1 font-['Space_Grotesk'] tracking-tight" href="#">SOCCER</a>
              <a className="text-[#9eabc8] font-medium hover:text-white transition-colors duration-200" href="#">LIVE FIXTURES</a>
              <a className="text-[#9eabc8] font-medium hover:text-white transition-colors duration-200" href="#">AI INSIGHTS</a>
          ...
          <div className="flex items-center gap-4">
            <div className="relative bg-[#0b203d] px-4 py-2 rounded-lg hidden lg:flex items-center gap-2">
              ...
              <input className="bg-transparent border-none focus:ring-0 text-sm p-0 w-48 text-[#dbe6ff] outline-none" placeholder="Search leagues..." type="text" />
            </div>
        ...
        <aside className="fixed left-0 top-16 h-[calc(100vh-64px)] w-64 bg-[#02132b] flex-col py-6 overflow-y-auto hidden xl:flex">
          <div className="px-6 mb-8">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-lg font-black text-[#6bff8f] font-['Space_Grotesk']">SOCCER HUB</span>
              <div className="bg-[#6bff8f]/20 text-[#6bff8f] text-[10px] px-1.5 py-0.5 rounded font-bold uppercase">AI PRO</div>
            </div>
            <p className="text-[10px] text-[#9eabc8] font-bold tracking-widest">TACTICAL FILTERS</p>
          </div>
          <nav className="flex-grow space-y-1">
            ...
            <a className="flex items-center gap-3 text-[#9eabc8] py-3 px-6 hover:bg-[#0b203d]/50 hover:text-white transition-all" href="#">
              ...
              <span className="font-medium">Today's Slate</span>
            </a>
            <a className="flex items-center gap-3 text-[#9eabc8] py-3 px-6 hover:bg-[#0b203d]/50 hover:text-white transition-all" href="#">
            ...
            <div className="pt-6 px-6 pb-2">
              <p className="text-[10px] text-[#9eabc8] font-bold tracking-widest uppercase">Elite Leagues</p>
            </div>
            <a className="flex items-center gap-3 text-[#9eabc8] py-3 px-6 hover:bg-[#0b203d]/50 hover:text-white transition-all" href="#">
