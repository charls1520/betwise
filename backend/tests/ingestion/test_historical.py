...
def test_download_football_data_co_uk(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("src.ingestion.historical.fetch_understat_historical_season",
                        lambda year, league: pd.DataFrame([{"Team": "Arsenal", "HomeTeam_Und": "Arsenal", "AwayTeam_Und": "Nottingham Forest", "Date": pd.to_datetime("2023-08-12"), "xG": 2.0, "xGA": 1.0},
                                                       {"Team": "Nottingham Forest", "HomeTeam_Und": "Arsenal", "AwayTeam_Und": "Nottingham Forest", "Date": pd.to_datetime("2023-08-12"), "xG": 1.0, "xGA": 2.0}]))
